...
public class Assignment3 {
	...
	public static void main(String[] args)throws Exception {
		...
		Thread.sleep(3000);
        System.out.println("contact us is displayes:"+element.isDisplayed());
		...
		Thread.sleep(3000);
        System.out.println("payment  is displayes:"+element.isDisplayed());
		Thread.sleep(3000);
        ...
        System.out.println(" return and policy is displayes:"+element.isDisplayed());
		Thread.sleep(3000);
		driver.navigate().back();
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
        System.out.println(" youtube is displayes:"+element.isDisplayed());
		Thread.sleep(3000);
driver.quit();
